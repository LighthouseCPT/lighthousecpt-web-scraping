...
def WestcliffUniversity_tuition(source):
    ...
    x3 = extract_inner_string(x2, 'International (F-1) Students', '$0.00 per $1,000', include_end=True)
    x_final = x1 + x3
    ...
    y3 = extract_inner_string(y2, 'International (F-1) Students', '$0.00 per $1,000', include_end=True)
    y_final = y1 + y3
